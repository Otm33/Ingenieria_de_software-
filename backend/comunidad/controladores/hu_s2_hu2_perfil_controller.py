...
class PerfilHistorialController:
    ...
    def ver_mi_perfil(self, usuario_orm) -> dict:
        from ..models import AcuerdoTrueque, Publicacion, Resena
        from ..serializers import PublicacionSerializer, ResenaSerializer, UsuarioSerializer
    ...
    def ver_perfil_otro(self, usuario_id: int) -> dict:
        from ..models import Publicacion, Resena, Usuario as UsuarioORM
    ...
    def listar_mis_trueques(self, usuario_orm, request=None) -> dict:
        from ..serializers import AcuerdoTruequeSerializer
