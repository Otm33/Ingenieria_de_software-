...
export default class ComercioController extends BaseController {
  ...
  async obtenerComercios() {
    return this.execute(async () => {
      const data = await this.repository.obtenerComercios()
  ...
  async obtenerClientes(termino = '') {
    return this.execute(async () => {
      const data = await this.repository.obtenerClientes(termino)
  ...
  async obtenerMiSaldoComercial() {
    return this.execute(async () => {
      const data = await this.repository.obtenerMiSaldoComercial()
  ...
  async emitirVuelto(clienteId, valorProducto, montoRecibido) {
    return this.execute(async () => {
      ...
      const data = await this.repository.emitirVuelto(
        clienteIdValido,
        valorProducto,
        montoRecibido,
        excedente,
  ...
  async pagarConSaldo(comercioId, monto) {
    return this.execute(async () => {
      ...
      const data = await this.repository.pagarConSaldo(comercioIdValido, montoValido)
      return this._mapOperacionComercial(data)
    })
  }
}
